...
HELP_TEXT = (
    ...
    "Приглашайте друзей и получайте бонусные дни за каждую их оплату.\n"
    "• За каждый купленный месяц реферала — <b>+5 дней</b> к вашей подписке\n"
    "• Бонус начисляется автоматически\n\n"
    "Ваша реферальная ссылка и статистика — в разделе <b>👥 Рефералы</b> главного меню."
)
...
CONNECT_INSTRUCTIONS = (
    ...
    "✅ Готово — VPN включён! 🚀\n\n"
    "⭐️ *Рекомендуем приложение Happ* — лучший выбор для подключения.\n\n"
